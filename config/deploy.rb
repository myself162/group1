...
role :web, "group1.com"                          # Your HTTP server, Apache/etc
role :app, "group1.com"                         # This may be the same as your `Web` server
role :db,  "group1.com"   , :primary => true # This is where Rails migrations will run
